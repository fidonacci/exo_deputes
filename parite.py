...
import analysis.csv_analysis as c_an
import analysis.xml_analysis as x_an
...
def parse_arguments():
    ...
    parser.add_argument("-ex", "--extension", help="""Kind of file to analyse. Is it a CSV or an XML?""")
...
def main(): 
    ...
    try:
        ...
        if arguments.extension == 'xml':
            x_an.launch_analysis(datafile)
        elif arguments.extension == 'csv':
            c_an.launch_analysis(datafile, arguments.byparty, arguments.info, arguments.displaynames,
                           arguments.searchname, arguments.index, arguments.groupfirst)
